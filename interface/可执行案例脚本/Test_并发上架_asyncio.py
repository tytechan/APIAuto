...
from multi_processing.multi_threading import CreateThread as CT

# 引入并发功能模块
import asyncio, multiprocessing, threading, threadpool
    ...
    def test01_box_uptray(self):
        ...
        try:
            ...
            for i in range(multiAccount):
                ...
                requests = threadpool.makeRequests(box_uptray(login_url,base_url,multiRow,token),(login_url,base_url,multiRow,token))
            ...
            print("每秒承载请求数（TPS)：", (multiAccount * one_work_num) / (end - start))
